\documentclass{jfpda2011}
% Ne pas modifier ========================================================================
\usepackage{amssymb}
\usepackage{natbib}

% Typographie française ==================================================================
\usepackage[english,frenchb]{babel} % typographie francaise
\usepackage[utf8]{inputenc} % saisie de caracteres accentues, etc.
\usepackage{lmodern} % polices vectorielles
\usepackage{xspace} % gestion des espaces a la francaise
\AddThinSpaceBeforeFootnotes % appel de note legerement decale du mot prec.
\FrenchFootnotes % numeros de notes a la francaise
...
\maketitle
\begin{abstract}
  This paper adresses the problem of apprenticeship learning, that
  ...
  function, IRL aims at learning the reward which defines this
  utility function from example trajectories. Many IRL algorithms
...
\end{figure}
\begin{figure}
\includegraphics[width=\textwidth]{../Code/courbe_b.pdf}
