#+TITLE: Reducing the Dimensionality of the Reward Space in the Inverse Reinforcement Learning Problem
...
clean:
	find . -maxdepth 1 -iname "ShowPpi.py"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.aux"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.bbl"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.blg"| xargs -t rm &&\
	find . -maxdepth 1 -iname "main.tex"| xargs -t rm &&\
	find . -maxdepth 1 -iname "main.pdf"| xargs -t rm &&\
	find . -maxdepth 1 -iname "slides.pdf"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.log"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.nav"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.out"| xargs -t rm &&\
	find . -maxdepth 1 -iname "*.snm"| xargs -t rm &&\
