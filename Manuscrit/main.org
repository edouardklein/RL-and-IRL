...
\begin{fullwidth}
\begin{itemize}
\item \fullcite{klein2011batch}
\item \fullcite{klein2011batch1}
\item \fullcite{klein2011batch2}
\end{itemize}
\end{fullwidth}
...
\begin{fullwidth}
\begin{itemize}
\item \fullcite{klein2012structured}
\item \fullcite{klein2012structured1}
\item \fullcite{klein2012structured2}
\item \fullcite{klein2012structured3}
\end{itemize}
\end{fullwidth}
...
\begin{fullwidth}
\begin{itemize}
\item \fullcite{klein2012cascading}
\item \fullcite{klein2012cascading1}
\end{itemize}
\end{fullwidth}
** Problèmes jouets
...
Pour pallier ce problème[fn::Qui n'affecte pas les approches supervisées.], nous pourrions également tenter de développer des algorithmes d'\gls{irl} pour lesquels l'optimisation finale de la récompense est simplifiée ou contournée.
