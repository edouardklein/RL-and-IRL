...
\author{Edouard Klein\inst{1,}\inst{2}, Bilal Piot\inst{2,}\inst{3}, Matthieu Geist\inst{2}, Olivier Pietquin\inst{2,}\inst{3}\thanks{The research leading to these results has received funding from the European Union Seventh Framework Programme (FP7/2007-2013) under grant agreement n\textdegree270780.}}
...
%\begin{abstract}
%The research leading to these results has received funding from the European Union Seventh Framework Programme (FP7/2007-2013) under grant agreement n\textdegree270780.
%\end{abstract}
