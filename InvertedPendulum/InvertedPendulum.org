...
#+begin_src python :tangle omega_E.py
#!/usr/bin/python
...
sys.path+=['..']
from LSPI import *
D_FILE_NAME = "Random_Samples.mat"
ACTION_FILE = "actions.mat"

print "Training the expert..."
D = genfromtxt( D_FILE_NAME )
actions = genfromtxt( ACTION_FILE )
omega_expert = LSPI( D, 2, 1, InvertedPendulum.phi, 30, actions, 0.01, 50 )
savetxt( "python_expert.mat", omega_expert )
