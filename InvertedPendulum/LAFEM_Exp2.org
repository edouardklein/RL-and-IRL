...
#define TRANS_WIDTH 7
#define ACTION_FILE "actions.mat"
#define LAFEM_REWARD_FILE "theta_lafem.mat"
...
int main( void ){
  gsl_matrix* theta_lafem = file2matrix( LAFEM_REWARD_FILE, 1 );
  gsl_matrix* D = file2matrix( D_FILE_NAME, TRANS_WIDTH );
...
omega_lafem.mat: LAFEM_Exp2_Results.exe theta_lafem.mat
	./LAFEM_Exp2_Results.exe > omega_lafem.mat
...
#define V_MAX (PI)
#define LAFEM_REWARD_FILE "theta_lafem.mat"
#define LAFEM_Q_FILE "omega_lafem.mat"
...
int main( void ){
  ...
  gsl_matrix* omega_lafem = file2matrix( LAFEM_Q_FILE, 1 );
  g_mOmega = omega_lafem;
  for( int i=0; i<GRID_V_SIZE; i++ ){
    double v = V_MIN + ((double)i)*( (V_MAX-V_MIN)/((double)GRID_V_SIZE - 1.) );
    for( int j=0; j< GRID_P_SIZE; j++){
  ...
  FILE* f_true_R = fopen( "LAFEM_Exp2_true_R.dat", "w" );
  FILE* f_lafem_R = fopen( "LAFEM_Exp2_lafem_R.dat", "w" );
  FILE* f_V_expert = fopen( "LAFEM_Exp2_Vexpert.dat", "w" );
  FILE* f_V_agent = fopen( "LAFEM_Exp2_Vagent.dat", "w" );
...
#+srcname: LAFEM_Exp2_make
#+begin_src makefile
LAFEM_Exp2_true_R.mat: LAFEM_Exp2_Plot.exe theta_lafem.mat omega_lafem.mat theta_lafem.mat
	./LAFEM_Exp2_Plot.exe

LAFEM_Exp2_lafem_R.mat: LAFEM_Exp2_Plot.exe theta_lafem.mat omega_lafem.mat theta_lafem.mat
	./LAFEM_Exp2_Plot.exe

LAFEM_Exp2_Vexpert.mat: LAFEM_Exp2_Plot.exe theta_lafem.mat omega_lafem.mat theta_lafem.mat
	./LAFEM_Exp2_Plot.exe

LAFEM_Exp2_Vagent.mat: LAFEM_Exp2_Plot.exe theta_lafem.mat omega_lafem.mat theta_lafem.mat
	./LAFEM_Exp2_Plot.exe
...
LAFEM_Exp2_Plot.o: LAFEM_Exp2_Plot.c InvertedPendulum.h ../utils.h ../greedy.h ../RL_Globals.h phispi.h
