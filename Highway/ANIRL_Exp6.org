...
* Plotting
#+begin_src python :tangle ANIRL_Exp6_plot.py
...
myPlot.plot( D, 'blue', 'ANIRL_Exp6_fig1.pdf' )
...
#+srcname: ANIRL_Exp6_make
#+begin_src makefile
ANIRL_Exp6_plot.py: ANIRL_Exp6.org
	$(call tangle,"ANIRL_Exp6.org")

ANIRL_Exp6_fig1.pdf: ANIRL_Exp6_plot.py ANIRL_Exp6.mat ../Plot.py
	python ANIRL_Exp6_plot.py
