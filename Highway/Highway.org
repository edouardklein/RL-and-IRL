...
Pi = Highway.HDP( randR, "V_Random.mat" )
...
Pi = Highway.HDP( R, "Highway_V.mat" )
...
Highway_clean: 
	...
	find . -maxdepth 1 -iname "Highway.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "omega2mu.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "theta2omega.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "Playomega.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "EvaluateOmega.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "EvaluateOmegaN.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "RandomPlay.py"   | xargs $(XARGS_OPT) rm
	find . -maxdepth 1 -iname "RandomResults.py"   | xargs $(XARGS_OPT) rm
  #+end_src
