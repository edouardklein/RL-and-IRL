...
\end{eqnarray}
C'est d'ailleurs cette variante de l'expression qui sera utilisée si, au lieu d'injecter l'équation \eqref{hatRdef.eqn} dans la définition de la fonction de valeur comme nous l'avons fait pour obtenir l'équation \eqref{Vmu.eqn}, nous l'injectons dans la définition de la fonction de qualité. On obtient alors :
\begin{eqnarray}
