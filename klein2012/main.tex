...
We see also that if two policies share the same feature expectation, then these two policies have the same value function with respect to the reward function $R=\theta^T\psi,\forall \theta\in\mathbb{R}^p$. Indeed :
\begin{equation}
...
\theta_{t+1} &\leftarrow& \theta_t -\alpha_t{g_{\theta} \over \|g_{\theta}\|_2}.
\end{eqnarray}
%%%
