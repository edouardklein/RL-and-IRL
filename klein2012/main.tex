...
Si la fonction de récompense trouvée par LAFEM (Fig. \ref{onlyFig.fig} (b)) diffère de celle fournie à l'expert (Fig. \ref{onlyFig.fig} (a)) on constate en revanche que les fonctions de valeurs sont très similaires (Fig. \ref{onlyFig.fig} (c) et \ref{onlyFig.fig} (d)). Cela est une illustration du fait que le problème de l'ARI est mal posé en ceci qu'il n'y a pas qu'une seule récompense pouvant expliquer une politique.\\
