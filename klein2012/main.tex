...
\end{equation}
est convergente vers un minimiseur $\theta^*$ de $J_N$. Ce minimiseur vérifiera l'équation \eqref{eq:existence} car $M^*\subset\hat{M}$ et la politique de l'expert sera optimale pour la récompense relative à $\theta^*$ car l'équation \eqref{eq:existence} implique l'optimalité de Bellman.
