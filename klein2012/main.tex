...
\author{\Name{{\'E}douard Klein$^{\dag\ddag}$}, \Name{Bilal Piot$^{\dag\textrm{*}}$}, \Name{Matthieu Geist$^\dag$}, \Name{Olivier Pietquin$^{\dag\textrm{*}}$}\\
\Email{firstname.lastname@supelec.fr}\\
\addr $\dag$ {\'E}quipe IMS/MaLIS (Sup{\'e}lec), $\ddag$ {\'E}quipe ABC UMR 7503 (Loria-CNRS), * UMI 2958 (GeorgiaTech-CNRS).
}
