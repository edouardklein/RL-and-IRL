...
*** Figures
    #+begin_src makefile 
RTEcompile:
	make -C GridWorld Expert_Nice_View

RTEstartView:
	xpdf -remote RTE1 GridWorld/V_expert.pdf & xpdf -remote RTE2 GridWorld/true_reward.pdf

RTEview:
	xpdf -remote RTE1 -reload && xpdf -remote RTE2 -reload

RTEstopView:
	xpdf -remote RTE1 -quit & xpdf -remote RTE2 -quit
...
*** Tests
    #+begin_src makefile :tangle Makefile :noweb yes
<<testDP_make>>
RTEcompile: testDPcompile

RTEstartView: testDPstartView

RTEview: testDPview

RTEstopView: testDPstopView
