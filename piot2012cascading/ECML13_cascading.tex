...
\begin{figure}
   ...
   \subfigure[Reward found by CSA-IRL. The green zone shows where the data available to the algorithm lies in the state space.]{\label{tata}\begin{minipage}{.45\linewidth}\hspace{-3em}\includegraphics[width=1.2\linewidth]{"LAFEM_Exp3_lafem_R"}\end{minipage}}
  ...
  \subfigure[Optimal value function for the reward function found by CSA-IRL (Fig.~\ref{tata})]{\begin{minipage}{.45\linewidth}\includegraphics[width=1.2\linewidth]{"LAFEM_Exp3_Vagent"}\end{minipage}}
