...
Inspired from a problem seen in FIXME(qui l'utilise, déjà ?), we coded a driving simulator. The agent controls a car that can switch between the three lanes of the road, go off-road on either side and modulate between three speed levels. 
\includegraphics{"../Highway/Cascading_Exp1_fig1.pdf"}
\begin{itemize}
