...
lines = ax.plot([-1,-1],[-1,-2], color='red',label="CSI",lw=2,linestyle='-')
...
figlegend.legend(lines,("CSI","Pure Classification","Abbeel \& Ng IRL","Agent trained on a random reward","SCIRL","Expert","min, max","Standard deviation"),"center")
